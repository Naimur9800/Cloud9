...
#include "sp0a09mipi_Sensor_blx.h"
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xa16ad8cf,        //checksum value for Camera Auto Test
...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0x9d,0x05);//85);  
  write_cmos_sensor(0x9c,0x1a);//0e);  
  write_cmos_sensor(0xcd,0x0c);  
  //write_cmos_sensor(0xa4,0x01);
	write_cmos_sensor(0xfd,0x00);
  
  
  write_cmos_sensor(0x31,0x06);//0x03
...
UINT32 SP0A09MIPISensorInit_BLX(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
