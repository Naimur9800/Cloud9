...
#define  RG_Ratio_Typical 335 //golden module
#define  BG_Ratio_Typical 348	//modify by v3720 SWCS5093961B-VA OTP Report 16.11.24
// return value:
// bit[7]: 0 no otp info, 1 valid otp info
// bit[6]: 0 no otp wb, 1 valib otp wb
void ov5675_read_otp(void)
{
