...
#define MA_KEY_LEFT                _IO(MA_IOC_MAGIC,  21)                  //nav left
#define MA_KEY_DOWN                _IO(MA_IOC_MAGIC,  20)                  //nav down
#define MA_KEY_RIGHT               _IO(MA_IOC_MAGIC,  19)                  //nav right
...
#define	POWER_OFF              _IO(MA_IOC_MAGIC,    36)
#define POWER_ON               _IO(MA_IOC_MAGIC,    37)
