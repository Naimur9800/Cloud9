...
#define PFX "IMX135_OFILM_camera_sensor"
...
static DEFINE_SPINLOCK(imgsensor_drv_lock);
 extern BYTE ofilm_get_otp_module_id(void);
...
static SENSOR_DPCM_TYPE_ENUM imgsensor_dpcm_info[10] =
...
#else
extern bool otp_update_ofilm(BYTE update_sensor_otp_awb, BYTE update_sensor_otp_lsc);
extern void otp_clear_flag_ofilm(void);
#endif
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {//(ofilm_get_otp_module_id()==0x06)
            		if(ofilm_get_otp_module_id()==0x11){
#ifdef CONFIG_MTK_CAM_CAL
...
static kal_uint32 close(void)
{
	...
	otp_clear_flag_ofilm();//clear otp flag
#endif
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
            ...
            if(0 != imgsensor.update_sensor_otp_awb || 0 != imgsensor.update_sensor_otp_lsc) {
                otp_update_ofilm(imgsensor.update_sensor_otp_awb, imgsensor.update_sensor_otp_lsc);
            }
#endif
            break;
...
UINT32 IMX135_OFILM_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
