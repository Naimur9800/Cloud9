...
#include "gc8024mipi_Sensor_hz_hsd.h"
...
#define PFX "GC8024_HZ_HSD_camera_sensor"
#define LOG_1 LOG_INF("GC8024_HSD_IVO\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC8024_HZ_HSD_MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
#define LSC_WIDTH 				6
#define LSC_HEIGHT 				6
u16 otp_gc8024_hz_hsdcxt_af_data[2];

typedef struct otp_gc8024_hz_hsd{
...
/*AF-170714BRYAN*/
	for(index=0;index<2;index++)
	{
		...
		case 0x01:
			...
			LOG_INF("GC8024_OTP_AF group%d is valid !!\n", index + 1);
			otp_gc8024_hz_hsdcxt_af_data[0] = gc8024_otp_info.vcm_start;
			otp_gc8024_hz_hsdcxt_af_data[1] = gc8024_otp_info.vcm_end;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(gc8024_otp_info.module_info1== 0x13 && !strcmp(mtkfb_lcm_name,"ili9881c_hd720_dsi_vdo_hz_hsd")){
...
UINT32 GC8024_HZ_HSD_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
