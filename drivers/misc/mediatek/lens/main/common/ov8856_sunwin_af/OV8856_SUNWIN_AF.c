...
/*
 * OV8856_SUNWINAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "OV8856_SUNWIN_AF_DRV"
...
{
	int i4RetValue = 0;
//#if (defined(CONFIG_PROJECT_V3702)||defined(CONFIG_PROJECT_V3800)||defined(CONFIG_PROJECT_V3610)||defined(CONFIG_PROJECT_V3802))	
#if 1
...
#else 
		//modified for P4200 4H8 main camera 
		int  a_u2Mode = 5;	//linear a_u2Mode = 5
    char puSendCmd[2] = {(char)(a_u2Data >> 4) , (char)(((a_u2Data & 0xF) << 4)+a_u2Mode)};
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	char puSendCmd2[2] = {0xf2,0xa0};	//set tvib T_SRC //modified for P4200 4H8 main camera 
	#else
...
/* ////////////////////////////////////////////////////////////// */
long OV8856_SUNWIN_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int OV8856_SUNWIN_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
//#if (defined(CONFIG_PROJECT_V3702)||defined(CONFIG_PROJECT_V3800)||defined(CONFIG_PROJECT_V3610)||defined(CONFIG_PROJECT_V3802))	
        ...
        msleep(15);					//delay 15ms
	      	 ...
	      	 //modified for P4200 4H8 main camera 
        s4AF_WriteReg(300);	//when close camera, first backup to 300steps
        msleep(20);        	//delay 20ms for lens stable(15ms or more time,ex 20ms 30ms)
        s4AF_WriteReg(250);	
        msleep(20);					
        s4AF_WriteReg(200);	
        msleep(20);					
...
void OV8856_SUNWIN_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
