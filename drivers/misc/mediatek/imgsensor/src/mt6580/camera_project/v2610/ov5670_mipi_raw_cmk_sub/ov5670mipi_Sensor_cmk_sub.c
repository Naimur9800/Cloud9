...
#include "ov5670mipi_Sensor_cmk_sub.h"

#ifdef CONFIG_COMPAT
#include <linux/compat.h>
#endif
#define PFX "ov5670_camera_sensor_cmk_sub"
#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)
extern bool otp_update_wb_cmk_ov5670_sub(unsigned short golden_rg, unsigned short golden_bg);
extern signed char check_cmk_MID_ov5670_sub(bool bOnlyCheck);
...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR,//IMAGE_NORMAL,//IMAGE_HV_MIRROR,//IMAGE_NORMAL,				//mirrorflip information
...
/* Sensor output window information */
kal_uint16 ov5670MIPI_read_cmos_sensor_cmk_sub(kal_uint32 addr)
{
...
void ov5670MIPI_write_cmos_sensor_cmk_sub(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if( 0==check_cmk_MID_ov5670_sub(true) ) //it is not cmk module
    	{	

		LOG_INF("check_cmkMIDFailed\n");
			
	    	 *sensor_id = 0xFFFFFFFF;
	        return ERROR_SENSOR_CONNECT_FAIL;
    	}
	    *sensor_id = OV5670MIPI_SENSOR_ID_CMK;
	return ERROR_NONE;
}
...
static kal_uint32 open(void)
{
	...
	sensor_init();
    otp_update_wb_cmk_ov5670_sub(0x11F, 0x13D);
...
UINT32 OV5670_MIPI_RAW_SensorInit_CMK_SUB(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
