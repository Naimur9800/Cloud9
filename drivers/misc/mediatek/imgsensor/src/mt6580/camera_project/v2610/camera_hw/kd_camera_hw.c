...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if (pinSetIdx == 0)
			...
			ISP_MCLK2_EN(1);
#if 1       	
             if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN, currSensorName))) ||
            (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK, currSensorName))))
            {
			...
			PK_ERR("+ls.test.SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN11111111111");
			...
			if (TRUE != _hwPowerOn(VCAMA, VOL_2800)) {
				PK_DBG
				    ("[CAMERA SENSOR] Fail to enable digital power (VCAM_A), power id = %d\n",
				     VCAMD);
				goto _kdCISModulePowerOn_exit_;
			}
	...
	else if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN_SUB, currSensorName))) ||
            (currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK_SUB, currSensorName))))
		{
                			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
	...
	else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP, currSensorName)))
	{
                			/* First Power Pin low and Reset Pin Low */
		/*	if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
	...
	else if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN, currSensorName)))||
		(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK, currSensorName)))||
		(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT, currSensorName))))
		{
			PK_ERR("+ls.test.SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN----1-----");
                			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
						pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
	...
	else if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))||
		(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB, currSensorName))) ||
		(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName))))
		{
			PK_ERR("+ls.test.SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB----1-----");
                			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
						pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
	...
	//	mtkcam_gpio_set(pinSetIdx, CAMLDO, 0);
		...
		//	mtkcam_gpio_set(pinSetIdx, CAMLDO, 0);
		    if(TRUE != _hwPowerDown(VCAMA)){
				PK_DBG
				    ("[CAMERA SENSOR] Fail to OFF digital power (VCAM_A), power id = %d\n",
				     VCAMIO);
				goto _kdCISModulePowerOn_exit_;
			}
