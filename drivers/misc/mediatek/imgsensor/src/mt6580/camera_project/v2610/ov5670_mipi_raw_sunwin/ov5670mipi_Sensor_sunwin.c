...
#include "ov5670mipi_Sensor_sunwin.h"

#ifdef CONFIG_COMPAT
#include <linux/compat.h>
#endif
#define PFX "ov5670_camera_sensor_sunwin"
//#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)
#define LOG_INF(format, args...)	pr_err(PFX "[%s] " format, __FUNCTION__, ##args)
extern bool otp_update_wb_sunwin_ov5670(unsigned short golden_rg, unsigned short golden_bg);
extern signed char check_sunwin_MID_ov5670(bool bOnlyCheck);
...
/* Sensor output window information */
kal_uint16 ov5670MIPI_read_cmos_sensor_sunwin(kal_uint32 addr)
{
...
void ov5670MIPI_write_cmos_sensor_sunwin(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if( 0==check_sunwin_MID_ov5670(true) ) //it is not sunwin module
    	{	
...
static kal_uint32 open(void)
{
	...
	sensor_init();
 	  otp_update_wb_sunwin_ov5670(0x139, 0x154);//2610 liunian(0x139, 0x154)
...
UINT32 OV5670_MIPI_RAW_SensorInit_SunWin(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
