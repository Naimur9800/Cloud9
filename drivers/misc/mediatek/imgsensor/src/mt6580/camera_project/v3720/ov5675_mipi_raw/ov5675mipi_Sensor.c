...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,//SENSOR_OUTPUT_FORMAT_RAW_B,//sensor output first pixel color
...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_V_MIRROR,//IMAGE_NORMAL,	//IMAGE_HV_MIRROR,			//mirrorflip information
...
static void write_shutter(kal_uint16 shutter)
{
	...
	write_cmos_sensor(0x3502, (Reg_shutter << 4) & 0xF0);//ron.ma long exposure
...
write_cmos_sensor(0x3501, 0x38);//;1F;max expo= ([380e,380f]-4)/2.  ron.ma long exposure
write_cmos_sensor(0x3502, 0x40);//;20
write_cmos_sensor(0x3503, 0x08);//;[2]=0 real gain
write_cmos_sensor(0x3508, 0x02);//;04;  //ron.ma long gain
...
//ov5675_read_otp();
#ifdef OV5675_OTP_TEST_KEY
if(OTP_KEY == 2 ||OTP_KEY == 3)
{
    if ((OTP_KEY>>1) & 1)
    {
       ov5675_apply_otp();
...
write_cmos_sensor(0x3802, 0x00);
write_cmos_sensor(0x3803, 0x00);
write_cmos_sensor(0x3804, 0x0a);//2623 array hor  2592 1944
write_cmos_sensor(0x3805, 0x3f);
write_cmos_sensor(0x3806, 0x07);//1975  array ver
write_cmos_sensor(0x3807, 0xb7);
write_cmos_sensor(0x3808, 0x05);//1296  isp hor
write_cmos_sensor(0x3809, 0x10);
write_cmos_sensor(0x380a, 0x03);//972 isp ver
write_cmos_sensor(0x380b, 0xcc);
write_cmos_sensor(0x380c, 0x02);//ron.ma VTS  750
write_cmos_sensor(0x380d, 0xee);
write_cmos_sensor(0x380e, 0x07);//;03  ron.ma HTS  2000
write_cmos_sensor(0x380f, 0xd0);//;e8
write_cmos_sensor(0x3811, 0x08);//isp hor offset 8  low 8bit
write_cmos_sensor(0x3813, 0x08);//isp ver offset 8  low 8bit
write_cmos_sensor(0x3814, 0x03);
write_cmos_sensor(0x3815, 0x01);
write_cmos_sensor(0x3816, 0x03);
//write_cmos_sensor(0x3817, 0x01);//ron.ma add this is default value
write_cmos_sensor(0x3820, 0x8b);//  1000 1010
write_cmos_sensor(0x3821, 0x01);//   HDR bit 1 enable hdr
write_cmos_sensor(0x4008, 0x00);// BLC Black line start line
write_cmos_sensor(0x4009, 0x07);// Black line end line
write_cmos_sensor(0x4041, 0x03);//Z line end
write_cmos_sensor(0x0100, 0x01);
