...
#define AF_DRVNAME "IMX135_OFILM_AF_DRV"
...
static int s4IMX135_OFILM_AF_ReadReg(unsigned short *a_pu2Result)
{
...
{
	char puSendCmd2[2] = { 0x00, 0x00 };
	char puSendCmd3[2] = { 0x05, 0x6f };
	char puSendCmd4[2] = { 0x01, 0x39 };
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4IMX135_OFILM_AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long IMX135_OFILM_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int IMX135_OFILM_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void IMX135_OFILM_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
