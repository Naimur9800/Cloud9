...
UINT32 GC0310_YUV_SensorInit_CMK(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 SP0A20MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 SP0A20BLXMIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 SP0A20KMJMIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
/*A*/
...
UINT32 OV13850TDK_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV13850SY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
ACDK_KD_SENSOR_INIT_FUNCTION_STRUCT kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR+1] =
{
    ...
    {OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW_DARLING, OV5648MIPISensorInit_darling}, 
#endif
...
#endif
#if defined(OV13850TDK_MIPI_RAW)
    {OV13850TDK_SENSOR_ID, SENSOR_DRVNAME_OV13850TDK_MIPI_RAW, OV13850TDK_MIPI_RAW_SensorInit}, 
#endif

#if defined(OV13850SUNYU_MIPI_RAW)
    {OV13850SY_SENSOR_ID, SENSOR_DRVNAME_OV13850SY_MIPI_RAW, OV13850SY_MIPI_RAW_SensorInit}, 
#endif
...
#endif
#if defined(OV5670_MIPI_RAW_SUNWIN)
    {OV5670MIPI_SENSOR_ID_SUNWIN, SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN, OV5670_MIPI_RAW_SensorInit_SunWin},
#endif
#if defined(OV5670_MIPI_RAW_CMK)
    {OV5670MIPI_SENSOR_ID_CMK, SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK, OV5670_MIPI_RAW_SensorInit_CMK},
#endif
...
#endif
#if defined(GC0310_MIPI_YUV_BLX)
    {GC0310_SENSOR_ID_BLX, SENSOR_DRVNAME_GC0310_MIPI_YUV_BLX,GC0310_YUV_SensorInit_BLX},
#endif
#if defined(GC0310_MIPI_YUV_CMK)
    {GC0310_SENSOR_ID_CMK, SENSOR_DRVNAME_GC0310_MIPI_YUV_CMK,GC0310_YUV_SensorInit_CMK},
#endif
...
/*LCA Test*/
    ...
    {SP2508_RAW_SENSOR_ID, SENSOR_DRVNAME_SP2508_MIPI_RAW, SP2508_MIPI_RAW_SensorInit},
#endif
...
#if defined(S5K4H8_MIPI_RAW_SUB)
    {S5K4H8SUB_SENSOR_ID, SENSOR_DRVNAME_S5K4H8SUB_MIPI_RAW, S5K4H8SUB_MIPI_RAW_SensorInit},
#endif
    ...
    {SP0A20_YUV_SENSOR_ID, SENSOR_DRVNAME_SP0A20_MIPI_YUV, SP0A20MIPI_YUV_SensorInit},
#endif
#if defined(SP0A20BLX_MIPI_YUV)
    {SP0A20BLX_YUV_SENSOR_ID, SENSOR_DRVNAME_SP0A20BLX_MIPI_YUV, SP0A20BLXMIPI_YUV_SensorInit},
#endif
#if defined(SP0A20KMJ_MIPI_YUV)
    {SP0A20KMJ_YUV_SENSOR_ID, SENSOR_DRVNAME_SP0A20KMJ_MIPI_YUV, SP0A20KMJMIPI_YUV_SensorInit},
#endif
//p4200 end
#if defined(HI553_MIPI_RAW_SUNWIN)
    {HI553_SENSOR_ID, SENSOR_DRVNAME_HI553_MIPI_RAW_5MP, HI553_MIPI_RAW_SensorInit},
#endif

#if defined(HI553_MIPI_RAW_CMK)
    {HI553_SENSOR_ID, SENSOR_DRVNAME_HI553_MIPI_RAW_5MP, HI553_MIPI_RAW_SensorInit},
#endif

#if defined(SP0A09_MIPI_RAW_CMK)
    {SP0A09MIPI_SENSOR_ID_CMK, SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_CMK, SP0A09MIPISensorInit},
#endif
#if defined(SP2509_MIPI_RAW_CMK)
    {SP2509MIPI_SENSOR_ID_CMK, SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_CMK, SP2509MIPISensorInit},
#endif

#if defined(SP0A09_MIPI_RAW_BLX)
    {SP0A09MIPI_SENSOR_ID_BLX, SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_BLX, SP0A09MIPISensorInit_BLX},
#endif

#if defined(SP2509_MIPI_RAW_BLX)
    {SP2509MIPI_SENSOR_ID_BLX, SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_BLX, SP2509MIPISensorInit_BLX},
#endif

#if defined(OV5670_MIPI_RAW_BEFORE_CMK)
    {OV5670MIPI_SENSOR_ID_BEFORE_CMK, SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, OV5670_MIPI_RAW_SensorInit_before_CMK},
#endif
#if defined(GC5025_MIPI_RAW_SUNWIN)
   {GC5025MIPI_SENSOR_ID_SUNWIN, SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN,GC5025_MIPI_RAW_SensorInit_SunWin},
#endif
#if defined(GC5025_MIPI_RAW_CMK)
   {GC5025MIPI_SENSOR_ID_CMK, SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK,GC5025_MIPI_RAW_SensorInit_CMK},
#endif
#if defined(GC5025_MIPI_RAW_SUNWIN_SUB)
   {GC5025MIPI_SENSOR_ID_SUNWIN_SUB, SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB,GC5025_MIPI_RAW_SensorInit_SunWin_SUB},
#endif
#if defined(GC5025_MIPI_RAW_CMK_SUB)
   {GC5025MIPI_SENSOR_ID_CMK_SUB, SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB,GC5025_MIPI_RAW_SensorInit_CMK_SUB},
#endif
#if defined(GC5025_MIPI_RAW_CXT)
   {GC5025MIPI_SENSOR_ID_CXT, SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT,GC5025_MIPI_RAW_SensorInit_CXT},
#endif
#if defined(GC2385_MIPI_RAW)
   {GC2385_SENSOR_ID, SENSOR_DRVNAME_GC2385_MIPI_RAW,GC2385MIPI_RAW_SensorInit},
#endif

#if defined(GC033AMIPI_RAW_CXT)
    {GC033A_CXTMIPI_SENSOR_ID, SENSOR_DRVNAME_GC033A_CXT_MIPI_RAW,GC033A_CXTMIPI_RAW_SensorInit},
#endif
#if defined(GC5025_MIPI_RAW_CXT_SUB)
   {GC5025MIPI_SENSOR_ID_CXT_SUB, SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB,GC5025_MIPI_RAW_SensorInit_CXT_SUB},
#endif
