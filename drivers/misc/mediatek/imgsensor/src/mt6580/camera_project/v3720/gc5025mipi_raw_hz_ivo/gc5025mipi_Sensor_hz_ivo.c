...
#include "gc5025mipi_Sensor_hz_ivo.h"
...
#define PFX "GC5025_HZ_IVO_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025_HZ_IVO_MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
typedef struct otp_gc5025_hz_ivo
{
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(gc5025_otp_info.module_id == 0x13 && !strcmp(mtkfb_lcm_name,"ili9881c_hd720_dsi_vdo_hz_ivo")){
...
UINT32 GC5025_HZ_IVO_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
