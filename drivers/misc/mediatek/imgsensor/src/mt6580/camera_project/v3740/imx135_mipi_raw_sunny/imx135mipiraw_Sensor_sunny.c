...
#include "imx135mipiraw_Sensor_sunny.h"



/****************************Modify following Strings for debug****************************/
#define PFX "IMX135_SUNNY_camera_sensor"
...
extern BYTE sunny_get_otp_module_id(void);
#define MIPI_SETTLEDELAY_AUTO     0
#define MIPI_SETTLEDELAY_MANNUAL  1
#define IHDR_USED
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX135_SUNNY_SENSOR_ID,
...
#else
extern bool otp_update_sunny(BYTE update_sensor_otp_awb, BYTE update_sensor_otp_lsc);
extern void otp_clear_flag_sunny(void);
#endif
		...
		do {
			...
			*sensor_id+=1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				if( sunny_get_otp_module_id()== 0x01){
#ifdef CONFIG_MTK_CAM_CAL
...
static kal_uint32 close(void)
{
	...
	otp_clear_flag_sunny();//clear otp flag
#endif
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
            ...
            if(0 != imgsensor.update_sensor_otp_awb || 0 != imgsensor.update_sensor_otp_lsc) {
                otp_update_sunny(imgsensor.update_sensor_otp_awb, imgsensor.update_sensor_otp_lsc);
            }
#endif
            break;
...
UINT32 IMX135_SUNNY_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
