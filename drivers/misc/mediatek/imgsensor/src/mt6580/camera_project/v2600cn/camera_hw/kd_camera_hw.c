...
#define VOL_1000 1000000
	...
	/* power ON */
	if (On) {
		if(((0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName))||(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName)))&&(pinSetIdx == 0))
		...
		if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC033A_CXT_MIPI_RAW, currSensorName))){
			...
			if (TRUE != _hwPowerOn(VCAMD, VOL_1200)) {
				...
				||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2508_MIPI_RAW, currSensorName)))
					 ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC0310_MIPI_YUV_CMK, currSensorName)))
					 ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC0310_MIPI_YUV_BLX, currSensorName)))
				||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_CMK, currSensorName)))
					 ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_CMK, currSensorName)))
					 ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_BLX, currSensorName)))
					// ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName)))
			     ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_BLX, currSensorName))))
				
				{
				 ...
				 else if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2385_MIPI_RAW, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName))))
...
*/
			...
			if((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2385_MIPI_RAW, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName))))
		 		 {
		...
		if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC033A_CXT_MIPI_RAW, currSensorName))){
			...
			if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName))){
			...
			if (TRUE != _hwPowerDown(VCAMD)) {
			...
			else
				{
				 if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2355_MIPI_RAW, currSensorName)))
					 ...
					 ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_BLX, currSensorName)))
						  ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK, currSensorName)))
					  ||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_BLX, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2385_MIPI_RAW, currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName)))
					 )
				 	{
					 if (TRUE != _hwPowerDown(VCAMD_SUB)) {
						 PK_DBG
							 ("[CAMERA SENSOR] Fail to OFF core power (VCAMD_SUB),power id = %d\n",
							  VCAMD_SUB);
						 goto _kdCISModulePowerOn_exit_;
					 }
