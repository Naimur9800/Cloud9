	...
	if (On) {
		...
		else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_MIPI_RAW, currSensorName)))
		{
			...
			mdelay(10);
				...
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_OFILM_MIPI_RAW, currSensorName))))
		{
			/* First Power Pin low and Reset Pin Low */
			...
			pmic_config_interface(MT6350_PMIC_RG_VGP3_CAL_ADDR,0x07,0xf,8);
		...
		//malp add begin
		else if((currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC8024_MIPI_RAW_HZ_HSD, currSensorName))) ||
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC8024_MIPI_RAW_HZ_IVO, currSensorName)))  ||
					(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC8024_MIPI_RAW_COE_IVO, currSensorName)))) 
		{
		...
		else if((currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_HZ_HSD, currSensorName)))||
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_HZ_IVO, currSensorName))) ||
					(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_COE_IVO, currSensorName))) ||
						(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN, currSensorName))))
		{
...
//
				...
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_OFILM_MIPI_RAW, currSensorName))))
		{
			...
			mdelay(2);
			pmic_config_interface(MT6350_PMIC_RG_VGP3_CAL_ADDR,0x00,0xf,8);
			//DVDD  
			if (TRUE != _hwPowerDown(VCAMD)) {
				PK_DBG
					("[CAMERA SENSOR] Fail to OFF core power (VCAM_D),power id = %d\n",
