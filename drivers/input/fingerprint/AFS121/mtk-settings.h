...
//macro settings
#define MA_DRV_NAME             "spi_fingerprint1"

#define MA_DTS_NAME            "mediatek,mt6753-fingerprint"

#define MA_EINT_DTS_NAME        "mediatek,mt6753-fingerprint"

#define MA_INT_PIN_LABEL		"interrupts"
//macro settings end

//add by rulei.zhou for power
#define POWER_GPIO 0
#define POWER_VGP  1
//add end
