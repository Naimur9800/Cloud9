...
#define OV5670MIPI_SENSOR_ID_SUNWIN             0x5675  //sunwin ov5670
#define OV5670MIPI_SENSOR_ID_CMK             0x5677   
#define OV5670MIPI_SENSOR_ID_SUNWIN_SUB             (0x5675+1)  //sunwin ov5670
#define OV5670MIPI_SENSOR_ID_CMK_SUB             (0x5677 +1)
#define OV5670MIPI_SENSOR_ID_BEFORE_CMK             0x5678  
...
#define S5K4H8SUB_SENSOR_ID                     0x4089
...
#define S5K5E2YA_SENSOR_ID                      0x55a0
#define S5K5E2YASUB_SENSOR_ID                   0x55a1
...
#define GC0310_SENSOR_ID_BLX                 0xa311
#define GC0310_SENSOR_ID_CMK                0xa312
#define GC0313MIPI_YUV_SENSOR_ID                0xD0
#define GC0312_SENSOR_ID                        0xb310
#define GC5025MIPI_SENSOR_ID                      0x5025
#define GC5025MIPI_SENSOR_ID_SUNWIN                      0x5025+1
#define GC5025MIPI_SENSOR_ID_CMK                     0x5025+2
#define GC5025MIPI_SENSOR_ID_SUNWIN_SUB                      0x5025+3
#define GC5025MIPI_SENSOR_ID_CMK_SUB                      0x5025+4
#define GC5025MIPI_SENSOR_ID_CXT                      0x5025+5
#define GC5025MIPI_SENSOR_ID_CXT_SUB                      0x5025+6
//malp add begin
#define GC8024_HZ_HSD_MIPI_SENSOR_ID            0x8024
#define GC8024_HZ_IVO_MIPI_SENSOR_ID            0x8024+1
#define GC8024_COE_IVO_MIPI_SENSOR_ID           0x8024+2
#define GC5025_HZ_HSD_MIPI_SENSOR_ID            0x5025+7
#define GC5025_HZ_IVO_MIPI_SENSOR_ID            0x5025+8
#define GC5025_COE_IVO_MIPI_SENSOR_ID           0x5025+9
//malp add end
/*SP*/
#define SP0A19_YUV_SENSOR_ID                    0xA6
#define SP2518_YUV_SENSOR_ID                    0x53
#define SP2508_RAW_SENSOR_ID                   0x2508
#define SP0A20_YUV_SENSOR_ID                    0x2b
#define SP0A20BLX_YUV_SENSOR_ID                    0x2c
#define SP0A20KMJ_YUV_SENSOR_ID                    0x2d
/*A*/
...
#define HI553_SENSOR_ID                         0x0553
#define SP0A09MIPI_SENSOR_ID			0xa09
#define SP2509MIPI_SENSOR_ID			0x2509
#define SP0A09MIPI_SENSOR_ID_CMK			0xa0a
#define SP2509MIPI_SENSOR_ID_CMK			0x250a
#define SP0A09MIPI_SENSOR_ID_BLX			0xa0b
#define SP2509MIPI_SENSOR_ID_BLX			0x250b
	
#define OV5675MIPI_SENSOR_ID             	0x5675
#define OV8856_SENSOR_ID                 	0x885A
#define IMX135_SUNNY_01_SENSOR_ID               0x0133
#define IMX135_SUNWIN_01_SENSOR_ID              0x0134
#define IMX135_SUNWIN_SENSOR_ID          	0x0135
#define IMX135_SUNNY_SENSOR_ID                  0x0136
#define IMX135_OFILM_SENSOR_ID          	0x0137
#define OV8856_SENSOR_ID_SUB                 	0x885B
#define S5K4H8_SENSOR_ID_SUB                        0x4089
#define GC033A_CXTMIPI_SENSOR_ID                0x033a      
...
#define SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN   "ov5670mipiraw_sunwin"
#define SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK   "ov5670mipiraw_cmk"
#define SENSOR_DRVNAME_OV5670_MIPI_RAW_SUNWIN_SUB   "ov5670mipiraw_sunwin_sub"
#define SENSOR_DRVNAME_OV5670_MIPI_RAW_CMK_SUB   "ov5670mipiraw_cmk_sub"
#define SENSOR_DRVNAME_OV5670_MIPI_RAW_BEFORE_CMK   "ov5670mipiraw_before_cmk"
...
#define SENSOR_DRVNAME_S5K4H8SUB_MIPI_RAW          "s5k4h8mipiraw_sub"
...
#define SENSOR_DRVNAME_S5K5E2YASUB_MIPI_RAW        "s5k5e2yamipiraw_sub"
...
#define SENSOR_DRVNAME_HI842_MIPI_RAW			"hi842raw_sunwin"
#define SENSOR_DRVNAME_HI846_MIPI_RAW           "hi846mipiraw_sunwin"
/*MT*/
...
#define SENSOR_DRVNAME_GC0310_MIPI_YUV_BLX          "gc0310mipiyuv_blx"
#define SENSOR_DRVNAME_GC0310_MIPI_YUV_CMK          "gc0310mipiyuv_cmk"
...
//liaoshuang add 
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN   "gc5025mipiraw_sunwin" 
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB   "gc5025mipiraw_sunwin_sub"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK   "gc5025mipiraw_cmk"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_CMK_SUB   "gc5025mipiraw_cmk_sub"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT   "gc5025mipiraw_cxt"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB   "gc5025mipiraw_cxt_sub"
//malp add begin
#define SENSOR_DRVNAME_GC8024_MIPI_RAW_HZ_HSD   "gc8024mipiraw_cxt_hz_hsd"
#define SENSOR_DRVNAME_GC8024_MIPI_RAW_HZ_IVO   "gc8024mipiraw_cxt_hz_ivo"
#define SENSOR_DRVNAME_GC8024_MIPI_RAW_COE_IVO  "gc8024mipiraw_cxt_coe_ivo"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_HZ_HSD   "gc5025mipiraw_cxt_hz_hsd"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_HZ_IVO   "gc5025mipiraw_cxt_hz_ivo"
#define SENSOR_DRVNAME_GC5025_MIPI_RAW_COE_IVO  "gc5025mipiraw_cxt_coe_ivo"
//malp add end
/*SP*/
#define SENSOR_DRVNAME_SP0A19_YUV               "sp0a19yuv"
#define SENSOR_DRVNAME_SP2518_YUV               "sp2518yuv"
#define SENSOR_DRVNAME_SP2508_MIPI_RAW               "sp2508raw"
#define SENSOR_DRVNAME_SP0A20_MIPI_YUV               "sp0a20yuv"
#define SENSOR_DRVNAME_SP0A20BLX_MIPI_YUV               "sp0a20yuv_blx"
#define SENSOR_DRVNAME_SP0A20KMJ_MIPI_YUV               "sp0a20yuv_kmj"
/*A*/
...
#define SENSOR_DRVNAME_HI553_MIPI_RAW_5MP      "hi553mipiraw5mp"
#define SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP      "sp0a09mipiraw03mp"
#define SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP      "sp2509mipiraw2mp"
#define SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_CMK      "sp0a09mipiraw03mp_cmk"
#define SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_CMK      "sp2509mipiraw2mp_cmk"
#define SENSOR_DRVNAME_SP0A09_MIPI_RAW_03MP_BLX      "sp0a09mipiraw03mp_blx"
#define SENSOR_DRVNAME_SP2509_MIPI_RAW_2MP_BLX      "sp2509mipiraw2mp_blx"

#define SENSOR_DRVNAME_OV8856_MIPI_RAW		"ov8856mipiraw"
#define SENSOR_DRVNAME_OV5675_MIPI_RAW          "ov5675mipiraw" 
#define SENSOR_DRVNAME_IMX135_SUNWIN_MIPI_RAW   "imx135mipiraw_sunwin"
#define SENSOR_DRVNAME_IMX135_SUNNY_MIPI_RAW    "imx135mipiraw_sunny"
#define SENSOR_DRVNAME_IMX135_SUNNY_01_MIPI_RAW    "imx135mipiraw_sunny_01"
#define SENSOR_DRVNAME_IMX135_OFILM_MIPI_RAW   "imx135mipiraw_ofilm"
#define SENSOR_DRVNAME_OV8856_MIPI_RAW_SUB         "ov8856mipiraw_sub"
#define SENSOR_DRVNAME_S5K4H8_MIPI_RAW_SUB          "s5k4h8mipiraw_sub"
#define SENSOR_DRVNAME_IMX135_SUNWIN_01_MIPI_RAW    "imx135mipiraw_sunwin_01"
#define SENSOR_DRVNAME_GC033A_CXT_MIPI_RAW         "gc033amipiraw_cxt"         
/*******************************************************************************
*
********************************************************************************/
