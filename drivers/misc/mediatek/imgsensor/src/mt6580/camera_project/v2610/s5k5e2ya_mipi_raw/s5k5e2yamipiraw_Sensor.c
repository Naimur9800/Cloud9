...
extern int isMainCam;


static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K5E2YA_SENSOR_ID,
	
	.checksum_value = 0x41d96921,//0x87e356d9,
...
{{ 2576, 1936,	  8,	8, 2560, 1920, 1280,  960, 0000, 0000, 1280,  960,	  0,	0, 1280,  960}, // Preview 
 ...
 { 2576, 1936,	  8,    8, 2560, 1920,  640,  480, 0000, 0000,  640,  480,	  0,	0,  640,  480}, //hight speed video 
 { 2576, 1936,	  8,  248, 2560, 1440, 1280,  720, 0000, 0000, 1280,  720,	  0,	0, 1280,  720}};// slim video 
extern struct otp_info_t Darling_S5K5E2_OTP; 
extern uint32_t s5k5e2ya_liteon_read_otp_info(struct otp_info_t *S5K5E2_OTP);
extern uint32_t s5k5e2ya_liteon_update_awb(struct otp_info_t *S5K5E2_OTP);

kal_uint16 S5K5E2_read_cmos_sensor(kal_uint32 addr)
{
...
void S5K5E2_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static void preview_setting(void)
{
	...
	// Clock Setting
	write_cmos_sensor(0x0305,0x08); //PLLP (def:5)  //0x06 rock 2016.09.26
	write_cmos_sensor(0x0306,0x01); //0x00 rock 2016.09.26
	write_cmos_sensor(0x0307,0x26); //PLLM (def:CCh 204d --> B3h 179d) //0xe0 rock 2016.09.26
...
static kal_uint32 open(void)
{
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	s5k5e2ya_liteon_read_otp_info(&Darling_S5K5E2_OTP);
	/* initail sequence write in  */
	sensor_init();
    s5k5e2ya_liteon_update_awb(&Darling_S5K5E2_OTP);
	spin_lock(&imgsensor_drv_lock);
