...
static imgsensor_info_struct imgsensor_info = { 
  ...
  .custom5 = {
	...
	.i2c_addr_table = {0x50, /*0x20,*/0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
...
kal_uint8 hi553_read_cmos_sensor_for_otp(kal_uint16 addr)
{
    ...
    kdSetI2CSpeed(imgsensor_info.i2c_speed); // Add this func to set i2c speed by each sensor
    iReadRegI2C(pu_send_cmd, 2, (u8*)&get_byte, 2, 0x50);
...
static kal_uint32 open(void)
{
    ...
    sensor_init();
	otp_update_wb_sunwin_hi553(0x171,0x134);//jindy(0x0161,0x012d)
