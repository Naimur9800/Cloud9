...
#define AF_DRVNAME "S5K4H8_OFILM_AF_DRV"
...
/*
fangchsh add for AF voice issue
S[3:2] = 01; 1 code per step;
S[1:0] = 01; default,1x clk;
0101 = 5;default fix;
int a_u2Mode = 5;fix;
*/
	printk("[fangchsh] a_u2Mode = fix\n");
    int  a_u2Mode = 5;
...
/* ////////////////////////////////////////////////////////////// */
long S5K4H8_OFILM_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
*/
//fangchsh add for AF voice issue
static void AF_CloseDelay(void)
{
...
int S5K4H8_OFILM_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void S5K4H8_OFILM_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
#if 1
/*
fangchsh add for AF voice issue:
Tvib = 12ms(Golden value)
DLC rising time = Tvib/2
Linear rising time = Tvib
MCLK[1:0] = Tvib/2 = 6
Search spec table is MCLK[1:0] = 01,T_SRC[4:0] = 00010;
*/
	printk("[fangchsh] DLC register setting\n");
    int i4RetValue=0;
    char puSendCmd0[2] = {0xec,0xa3};//fix
    char puSendCmd1[2] = {0xa1,0x0d};//11 MCLK[1:0] = 1101 = 0x0d
    char puSendCmd2[2] = {0xf2,0x20};//T_SRC[4:0] 000 = 00100 000 = 0x20//update
    char puSendCmd3[2] = {0xdc,0x51};//fix
