...
#define GC2385_DEFAULT_DUMMY_PIXEL_NUMS   0x286 /* HB */
#define GC2385_DEFAULT_DUMMY_LINE_NUMS    0x010 /* VB */
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id =  GC2385_SENSOR_ID,//GC2385MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void set_shutter(kal_uint16 shutter)
{
	...
	if(shutter < 6) shutter = 6;*///ackman delete
...
static void preview_setting(void)
{
  LOG_INF("E!\n");	
   ...
   write_cmos_sensor(0xfe,0x00);
   LOG_INF("ackman Enable 2385sub set dummy preview!\n");
}    /*    preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("E! currefps:%d\n",currefps);
	 write_cmos_sensor(0xfe,0x00);
	  write_cmos_sensor(0xed,0x90);
	  write_cmos_sensor(0xfe,0x00);
	  LOG_INF("ackman Enable 2385sub set dummy capture!\n");
}
...
static void normal_video_setting(kal_uint16 currefps)
{
   ...
   write_cmos_sensor(0xed,0x90);
   write_cmos_sensor(0xfe,0x00);
   LOG_INF("ackman Enable 2385sub set dummy video!\n");
}
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    sensor_info->SensorHorFOV = 54;
    sensor_info->SensorVerFOV = 42;
...
static kal_uint32 set_max_framerate_by_scenario(MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    switch (scenario_id) {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
            ...
            imgsensor.min_frame_length = imgsensor.frame_length;
            spin_unlock(&imgsensor_drv_lock);
			Basic_Dummy_Line = imgsensor.min_frame_length - 1232;//ackman add for set dummy
            set_dummy();
