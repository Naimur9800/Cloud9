...
extern kal_uint16 ov5670MIPI_read_cmos_sensor_cmk_sub(kal_uint32 addr);
extern void ov5670MIPI_write_cmos_sensor_cmk_sub(kal_uint32 addr, kal_uint32 para);
...
#define ov5670_write_cmos_sensor(addr,para) ov5670MIPI_write_cmos_sensor_cmk_sub(addr,para)
#define ov5670_read_cmos_sensor(addr) ov5670MIPI_read_cmos_sensor_cmk_sub(addr)
...
signed char check_cmk_MID_ov5670_sub(bool bOnlyCheck);
...
*******************************************************************************/	
bool otp_update_wb_cmk_ov5670_sub(unsigned short golden_rg, unsigned short golden_bg) 
{
...
//	unsigned short bg_ratio ;
	...
	check_cmk_MID_ov5670_sub(false);
