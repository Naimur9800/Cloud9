...
#endif
#define PFX "ov5670_camera_sensor_cmk"
#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)
extern bool otp_update_wb_cmk_ov5670(unsigned short golden_rg, unsigned short golden_bg);
extern signed char check_cmk_MID_ov5670(bool bOnlyCheck);
...
/* Sensor output window information */
kal_uint16 ov5670MIPI_read_cmos_sensor_cmk(kal_uint32 addr)
{
...
void ov5670MIPI_write_cmos_sensor_cmk(kal_uint32 addr, kal_uint32 para)
{
...
/*	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
    ...
    if( 0==check_cmk_MID_ov5670(true) ) //it is not cmk module
    	{	
...
static kal_uint32 open(void)
{
	...
	sensor_init();
    otp_update_wb_cmk_ov5670(0x11F, 0x13D);//ZYQ add CMK typical for 3610 front camera
...
UINT32 OV5670_MIPI_RAW_SensorInit_CMK(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
