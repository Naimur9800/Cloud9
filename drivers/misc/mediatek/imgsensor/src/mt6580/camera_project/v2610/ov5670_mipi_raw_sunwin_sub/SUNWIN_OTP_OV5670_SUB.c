...
//#include "ov5670mipi_Camera_Sensor_para_sunwin.h"
//#include "ov5670mipi_CameraCustomized_sunwin.h"
...
//#define printk(fmt, arg...) printk("[ov5670MIPIRaw_OTP_SUNWIN]%s: " fmt "\n", __FUNCTION__ ,##arg)//LINE <> <DATE20130923> <ov5670 OTP log> wupingzhou

extern kal_uint16 ov5670MIPI_read_cmos_sensor_sunwin_sub(kal_uint32 addr);
extern void ov5670MIPI_write_cmos_sensor_sunwin_sub(kal_uint32 addr, kal_uint32 para);
...
#define ov5670_write_cmos_sensor(addr,para) ov5670MIPI_write_cmos_sensor_sunwin_sub(addr,para)
#define ov5670_read_cmos_sensor(addr) ov5670MIPI_read_cmos_sensor_sunwin_sub(addr)
...
signed char check_sunwin_MID_ov5670_sub(bool bOnlyCheck);
...
*******************************************************************************/	
bool otp_update_wb_sunwin_ov5670_sub(unsigned short golden_rg, unsigned short golden_bg) 
{
...
//	unsigned short bg_ratio ;
	...
	check_sunwin_MID_ov5670_sub(false);
