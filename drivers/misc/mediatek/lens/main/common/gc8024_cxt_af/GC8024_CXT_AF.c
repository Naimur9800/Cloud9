...
#define AF_DRVNAME "GC8024_CXT_AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GC8024_CXT_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int GC8024_CXT_AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void GC8024_CXT_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
