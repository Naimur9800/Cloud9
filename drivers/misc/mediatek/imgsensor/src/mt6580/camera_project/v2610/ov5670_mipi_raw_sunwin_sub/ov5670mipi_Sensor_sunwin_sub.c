...
#include "ov5670mipi_Sensor_sunwin_sub.h"

#ifdef CONFIG_COMPAT
#include <linux/compat.h>
#endif
#define PFX "ov5670_camera_sensor_sunwin_sub"
#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)
extern bool otp_update_wb_sunwin_ov5670_sub(unsigned short golden_rg, unsigned short golden_bg);
extern signed char check_sunwin_MID_ov5670_sub(bool bOnlyCheck);
...
static imgsensor_struct imgsensor = {
	.mirror = IMAGE_HV_MIRROR,//IMAGE_HV_MIRROR,//IMAGE_NORMAL,//IMAGE_V_MIRROR,				//mirrorflip information
...
/* Sensor output window information */
kal_uint16 ov5670MIPI_read_cmos_sensor_sunwin_sub(kal_uint32 addr)
{
...
void ov5670MIPI_write_cmos_sensor_sunwin_sub(kal_uint32 addr, kal_uint32 para)
{
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror) {
		case IMAGE_NORMAL:
			...
			write_cmos_sensor(0x450b,0x00);//add to locked first pixel_B
			break;
		case IMAGE_H_MIRROR:
			write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0xF9) | 0x00));
		...
		case IMAGE_V_MIRROR:
			...
			write_cmos_sensor(0x3821,((read_cmos_sensor(0x3821) & 0xF9) | 0x06));
			write_cmos_sensor(0x450b,0x20);//add to locked first pixel_B
			break;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0302, 0x68); //;78 MIPI datarate 960 -> 840
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if( 0==check_sunwin_MID_ov5670_sub(true) ) //it is not sunwin module
    	{	
	    ...
	    *sensor_id = OV5670MIPI_SENSOR_ID_SUNWIN;
	return ERROR_NONE;
}
...
static kal_uint32 open(void)
{
	...
	sensor_init();
 	  otp_update_wb_sunwin_ov5670_sub(0x149, 0x153);//raoxuezhen add sanyingxing typical for V3702 front camera 2015/12/3 
...
UINT32 OV5670_MIPI_RAW_SensorInit_SunWin_SUB(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
