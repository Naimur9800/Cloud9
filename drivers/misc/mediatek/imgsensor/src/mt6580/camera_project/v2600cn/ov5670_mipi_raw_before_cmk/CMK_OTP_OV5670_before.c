...
extern kal_uint16 ov5670MIPI_read_cmos_sensor_before_cmk(kal_uint32 addr);
extern void ov5670MIPI_write_cmos_sensor_before_cmk(kal_uint32 addr, kal_uint32 para);
...
#define ov5670_write_cmos_sensor(addr,para) ov5670MIPI_write_cmos_sensor_before_cmk(addr,para)
#define ov5670_read_cmos_sensor(addr) ov5670MIPI_read_cmos_sensor_before_cmk(addr)
...
signed char check_cmk_MID_ov5670_before(bool bOnlyCheck);
...
*******************************************************************************/	
bool otp_update_wb_cmk_ov5670_beofore(unsigned short golden_rg, unsigned short golden_bg) 
{
...
//	unsigned short bg_ratio ;
	...
	check_cmk_MID_ov5670_before(false);
