...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if (pinSetIdx == 0)
			...
			ISP_MCLK2_EN(1);
#endif
		if((((0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))&&(pinSetIdx == 0))||(((0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName)))&&(pinSetIdx == 0)))
			goto _kdCISModulePowerOn_exit_;


		PK_DBG("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
 if (currSensorName
			   && (0 == strcmp(SENSOR_DRVNAME_HI842_MIPI_RAW, currSensorName))) {
	...
	else if(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_GC8024_MIPI_RAW, currSensorName)))
		{
			...
			//IDX_PS_CMPDN:DW9714 AF XSD
		}

 else if ((currSensorName
		 && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN, currSensorName)))||(currSensorName
		 && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT, currSensorName)))) {
	 /* First Power Pin low and Reset Pin Low */
	 if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
		 mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
				 pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
	 ...
	 mdelay(20);
		 ...
		 && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))||(currSensorName
		 && (0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName)))) {
	if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
		mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
				pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
 ...
 if (currSensorName
			   && (0 == strcmp(SENSOR_DRVNAME_GC2385_MIPI_RAW, currSensorName))) {
			/* First Power Pin low and Reset Pin Low */
	 if (GPIO_CAMERA_INVALID != pinSet[1-pinSetIdx][IDX_PS_CMPDN])
		 mtkcam_gpio_set(1-pinSetIdx, CAMPDN,
				 pinSet[1-pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
	 ...
	 /* VCAM_IO */
		...
		else if((currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNWIN_MIPI_RAW, currSensorName)))||
				(currSensorName&& (0 == strcmp(SENSOR_DRVNAME_IMX135_SUNNY_MIPI_RAW, currSensorName))))
		{
			/* First Power Pin low and Reset Pin Low */
		...
		else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV5675_MIPI_RAW, currSensorName)))
		{
		...
		if (currSensorName &&
			...
			if (TRUE != _hwPowerDown(VCAMAF)) {
				...
				(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT, currSensorName)))||(currSensorName &&
				(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN, currSensorName)))) {
			...
			if (TRUE != _hwPowerDown(VCAMIO)) {
				...
				(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_CXT_SUB, currSensorName)))||(currSensorName &&
				(0 == strcmp(SENSOR_DRVNAME_GC5025_MIPI_RAW_SUNWIN_SUB, currSensorName)))) {
