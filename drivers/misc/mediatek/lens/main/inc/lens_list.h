...
#define OV13850AF_SetI2Cclient OV13850AF_SetI2Cclient_Main
#define OV13850AF_Ioctl OV13850_Ioctl_Main
#define OV13850AF_Release OV13850_Release_Main
extern void OV13850AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				int *pAF_Opened);
...
#ifdef CONFIG_MTK_LENS_OV8856_SUNWIN_AF_SUPPORT
#define OV8856_SUNWIN_AF_SetI2Cclient OV8856_SUNWIN_AF_SetI2Cclient_Main
#define OV8856_SUNWIN_AF_Ioctl OV8856_SUNWIN_AF_Ioctl_Main
#define OV8856_SUNWIN_AF_Release OV8856_SUNWIN_AF_Release_Main
extern void OV8856_SUNWIN_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long OV8856_SUNWIN_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int  OV8856_SUNWIN_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_GC8024_CXT_AF_SUPPORT
#define GC8024_CXT_AF_SetI2Cclient GC8024_CXT_AF_SetI2Cclient_Main
#define GC8024_CXT_AF_Ioctl GC8024_CXT_AF_Ioctl_Main
#define GC8024_CXT_AF_Release GC8024_CXT_AF_Release_Main
extern void GC8024_CXT_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GC8024_CXT_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int  GC8024_CXT_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif


#ifdef CONFIG_MTK_LENS_IMX135_SUNWIN_AF_SUPPORT
#define IMX135_SUNWIN_AF_SetI2Cclient IMX135_SUNWIN_AF_SetI2Cclient_Main
#define IMX135_SUNWIN_AF_Ioctl IMX135_SUNWIN_AF_Ioctl_Main
#define IMX135_SUNWIN_AF_Release IMX135_SUNWIN_AF_Release_Main
extern void IMX135_SUNWIN_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_SUNWIN_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int IMX135_SUNWIN_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_IMX135_SUNWIN_01_AF_SUPPORT
#define IMX135_SUNWIN_01_AF_SetI2Cclient IMX135_SUNWIN_01_AF_SetI2Cclient_Main
#define IMX135_SUNWIN_01_AF_Ioctl IMX135_SUNWIN_01_AF_Ioctl_Main
#define IMX135_SUNWIN_01_AF_Release IMX135_SUNWIN_01_AF_Release_Main
extern void IMX135_SUNWIN_01_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_SUNWIN_01_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int IMX135_SUNWIN_01_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#ifdef CONFIG_MTK_LENS_IMX135_SUNNY_AF_SUPPORT
#define IMX135_SUNNY_AF_SetI2Cclient IMX135_SUNNY_AF_SetI2Cclient_Main
#define IMX135_SUNNY_AF_Ioctl IMX135_SUNNY_AF_Ioctl_Main
#define IMX135_SUNNY_AF_Release IMX135_SUNNY_AF_Release_Main
extern void IMX135_SUNNY_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_SUNNY_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int IMX135_SUNNY_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_IMX135_SUNNY_01_AF_SUPPORT
#define IMX135_SUNNY_01_AF_SetI2Cclient IMX135_SUNNY_01_AF_SetI2Cclient_Main
#define IMX135_SUNNY_01_AF_Ioctl IMX135_SUNNY_01_AF_Ioctl_Main
#define IMX135_SUNNY_01_AF_Release IMX135_SUNNY_01_AF_Release_Main
extern void IMX135_SUNNY_01_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_SUNNY_01_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int  IMX135_SUNNY_01_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_IMX135_OFILM_AF_SUPPORT
#define IMX135_OFILM_AF_SetI2Cclient IMX135_OFILM_AF_SetI2Cclient_Main
#define IMX135_OFILM_AF_Ioctl IMX135_OFILM_AF_Ioctl_Main
#define IMX135_OFILM_AF_Release IMX135_OFILM_AF_Release_Main
extern void IMX135_OFILM_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_OFILM_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int IMX135_OFILM_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#ifdef CONFIG_MTK_LENS_S5K4H8_OFILM_AF_SUPPORT
#define S5K4H8_OFILM_AF_SetI2Cclient S5K4H8_OFILM_AF_SetI2Cclient_Main
#define S5K4H8_OFILM_AF_Ioctl S5K4H8_OFILM_AF_Ioctl_Main
#define S5K4H8_OFILM_AF_Release S5K4H8_OFILM_AF_Release_Main
extern void S5K4H8_OFILM_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long S5K4H8_OFILM_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int S5K4H8_OFILM_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
#ifdef CONFIG_MTK_LENS_IMX135_SUNWIN_AF_DW9718_SUPPORT
#define IMX135_DW9718_AF_SetI2Cclient IMX135_DW9718_AF_SetI2Cclient_Main
#define IMX135_DW9718_AF_Ioctl IMX135_DW9718_AF_Ioctl_Main
#define IMX135_DW9718_AF_Release IMX135_DW9718_AF_Release_Main
extern void IMX135_DW9718_AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long IMX135_DW9718_AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int IMX135_DW9718_AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
