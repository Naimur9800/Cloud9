...
//#define LOGE(format, args...)   printk(ANDROID_LOG_ERROR, PFX, "[%s] " format, __FUNCTION__, ##args)



#define S5K4H8_OTP_USE
#ifdef S5K4H8_OTP_USE
extern void otp_ofilm_update_wb(void);
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.pre = {
		...
		.framelength =3168, //3168,			//record different mode's framelength //全景需走zsdcc,帧率要降低到24fps.wupingzhou,20160201.
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 1632,		//record different mode's width of grabwindow
		.grabwindow_height = 1224,		//record different mode's height of grabwindow
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.max_framerate = 240,	 //全景需走zsdcc,帧率要降低到24fps.wupingzhou,20160201.
	},
	.cap = {
		.pclk = 280000000,
		.linelength =3744,
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor(0x030C, 0x0008);
  write_cmos_sensor(0x030E, 0x00E8);
  write_cmos_sensor(0x3008, 0x0000);
  write_cmos_sensor(0x0100, 0x0100);
		check_output_stream_on();
#ifdef S5K4H8_OTP_USE
//printk("geroge --- otp start ---\n");
otp_ofilm_update_wb();
