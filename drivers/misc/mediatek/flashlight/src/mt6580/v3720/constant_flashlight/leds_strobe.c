...
struct pinctrl_state *flashlight_ext2_h = NULL;
struct pinctrl_state *flashlight_ext2_l = NULL;
...
static int Flashlight_use_gpio_probe(struct platform_device *pdev)
{
	...
	PK_DBG("Flashlight_use_gpio_probe\n");
	   ...
	   flashlight_ext2_l= pinctrl_lookup_state(flashlightpinctrl, "flashlightpin_ext20");
	   if (IS_ERR(flashlight_ext1_l)) {
	   	PK_DBG("IS_ERR(flashlight_ext1_l) \n");
	   return -1;	
	   }
	   
	   flashlight_ext2_h= pinctrl_lookup_state(flashlightpinctrl, "flashlightpin_ext21");
	   if (IS_ERR(flashlight_ext1_h)) {
	   	PK_DBG("IS_ERR(flashlight_ext1_h) \n");
	   return -1;	
	   }
