...
#define MODULE_ID_s5k5e2ya_liteon		0x0002    //xxx: sensor P/N;  yyy: module vendor
...
#define OTP_AUTO_LOAD_LSC_s5k5e2ya_liteon

#define RG_TYPICAL_s5k5e2ya_liteon    	0x0232
#define BG_TYPICAL_s5k5e2ya_liteon		0x01D9
...
#define S5K5E2YAM_OTP_RG_MIN  0x133  //0.57 x 1024  = 584
#define S5K5E2YAM_OTP_BG_MAX  0x2B9  //0.68 x 1024  = 697
#define S5K5E2YAM_OTP_BG_MIN  0x1B4  //0.48 x 1024  = 492
#define LOG_TAG  "S5K5E2YA:"
...
#endif
extern  void S5K5E2_write_cmos_sensor(u16 addr, u32 para);
extern  kal_uint16 S5K5E2_read_cmos_sensor(u32 addr);

uint32_t s5k5e2ya_liteon_read_otp_info(struct otp_info_t *otp_info)
{
	...
	otp_info->rg_ratio_typical=RG_TYPICAL_s5k5e2ya_liteon;
	otp_info->bg_ratio_typical=BG_TYPICAL_s5k5e2ya_liteon;
	...
	//read lsc data. check moudule for debug
	{
		...
		S5K5E2_write_cmos_sensor(0x0a00, 0x04); //make initial state
		S5K5E2_write_cmos_sensor(0x0a02, 0x05); //page set
		S5K5E2_write_cmos_sensor(0x0a00, 0x01); //otp enable read
		mdelay(5);
		
		temp1 = S5K5E2_read_cmos_sensor(0x0A04);
		temp2 = S5K5E2_read_cmos_sensor(0x0A05);
		temp3 = S5K5E2_read_cmos_sensor(0x0A06);
		...
		else if((otp_info->flag & 0x03) == 0x02)
		{
			int nStartAddr = 576;
			int nEndAddr = 936;
			S5K5E2_write_cmos_sensor(0x0a00, 0x04);
			S5K5E2_write_cmos_sensor(0x0a02, nStartAddr/64);
			S5K5E2_write_cmos_sensor(0x0a00, 0x01);
			for(i = nStartAddr;i < nEndAddr; i++)
			{
				if(i%64 == 0)
				{
					S5K5E2_write_cmos_sensor(0x0a00, 0x04);
					S5K5E2_write_cmos_sensor(0x0a02, i/64);
					S5K5E2_write_cmos_sensor(0x0a00, 0x01);
					mdelay(5);
					lsc_data_count += S5K5E2_read_cmos_sensor(0x0A04 + i%64);	
				}
			}
			
		}
		S5K5E2_write_cmos_sensor(0x0a00, 0x04); //make initial state
		S5K5E2_write_cmos_sensor(0x0a00, 0x00); //disable enable read	
		if(lsc_data_count == 0) {
    ...
    //Read module info	
	S5K5E2_write_cmos_sensor(0x0a00, 0x04); //make initial state
	S5K5E2_write_cmos_sensor(0x0a02, 0x05); //page 5,module info part in page 5
	S5K5E2_write_cmos_sensor(0x0a00, 0x01); //otp enable read
	mdelay(5);
	
	temp1 = S5K5E2_read_cmos_sensor(0x0A0A);
	temp2 = S5K5E2_read_cmos_sensor(0x0A0B);
	temp3 = S5K5E2_read_cmos_sensor(0x0A0C);
	otp_info->flag = temp1 | temp2 | temp3;
	...
	{
		S5K5E2_write_cmos_sensor(0x0a00, 0x04);
		S5K5E2_write_cmos_sensor(0x0a02, 0x05);
		S5K5E2_write_cmos_sensor(0x0a00, 0x01);
		infoMidTemp1 = S5K5E2_read_cmos_sensor(0x0A0F);
		infoLensIDTemp1 = S5K5E2_read_cmos_sensor(0x0A10);
		infoMidTemp2 = S5K5E2_read_cmos_sensor(0x0A1F);
		infoLensIDTemp2 = S5K5E2_read_cmos_sensor(0x0A20);
		infoMidTemp3 = S5K5E2_read_cmos_sensor(0x0A2F);
		infoLensIDTemp3 = S5K5E2_read_cmos_sensor(0x0A30);
	...
	{
		S5K5E2_write_cmos_sensor(0x0a00, 0x04);
		S5K5E2_write_cmos_sensor(0x0a02, 0x04);
		S5K5E2_write_cmos_sensor(0x0a00, 0x01);
		infoMidTemp1 = S5K5E2_read_cmos_sensor(0x0A0F);
		infoLensIDTemp1 = S5K5E2_read_cmos_sensor(0x0A10);
		infoMidTemp2 = S5K5E2_read_cmos_sensor(0x0A1F);
	...
	S5K5E2_write_cmos_sensor(0x0a00, 0x04);
	S5K5E2_write_cmos_sensor(0x0a00, 0x00);
	mdelay(5);
	...
	S5K5E2_write_cmos_sensor(0x0a00, 0x01);
	mdelay(5);
	wbFlagTemp1 = S5K5E2_read_cmos_sensor(0x0A07);
	wbFlagTemp2 = S5K5E2_read_cmos_sensor(0x0A08);
	wbFlagTemp3 = S5K5E2_read_cmos_sensor(0x0A09);
	...
	else if(otp_info->flag == 0x01)  //group1
	{
		...
		S5K5E2_write_cmos_sensor(0x0a02, 0x05);
		S5K5E2_write_cmos_sensor(0x0a00, 0x01);
		wbRGMsb1 = S5K5E2_read_cmos_sensor(0x0A14);
		wbRGLsb1 = S5K5E2_read_cmos_sensor(0x0A15);
		wbBGMsb1 = S5K5E2_read_cmos_sensor(0x0A16);
		wbBGLsb1 = S5K5E2_read_cmos_sensor(0x0A17);
		wbRGMsb2 = S5K5E2_read_cmos_sensor(0x0A24);
		wbRGLsb2 = S5K5E2_read_cmos_sensor(0x0A25);
		wbBGMsb2 = S5K5E2_read_cmos_sensor(0x0A26);
		wbBGLsb2 = S5K5E2_read_cmos_sensor(0x0A27);
		wbRGMsb3 = S5K5E2_read_cmos_sensor(0x0A34);
		wbRGLsb3 = S5K5E2_read_cmos_sensor(0x0A35);
		wbBGMsb3 = S5K5E2_read_cmos_sensor(0x0A36);
		wbBGLsb3 = S5K5E2_read_cmos_sensor(0x0A37);
...
uint32_t s5k5e2ya_liteon_update_awb(struct otp_info_t *otp_info)
{
	uint32_t rtn = SENSOR_SUCCESS;
	//struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;
	...
	S5K5E2_write_cmos_sensor(0x020e, (g_gain&0xff00)>>8);
	S5K5E2_write_cmos_sensor(0x020f, g_gain&0xff);
	S5K5E2_write_cmos_sensor(0x0210, (r_gain&0xff00)>>8);
	S5K5E2_write_cmos_sensor(0x0211, r_gain&0xff);
	S5K5E2_write_cmos_sensor(0x0212, (b_gain&0xff00)>>8);
	S5K5E2_write_cmos_sensor(0x0213, b_gain&0xff);
	S5K5E2_write_cmos_sensor(0x0214, (g_gain&0xff00)>>8);
	S5K5E2_write_cmos_sensor(0x0215, g_gain&0xff);
	
	return SENSOR_SUCCESS;
}

#ifndef OTP_AUTO_LOAD_LSC_s5k5e2ya_liteon
...
#endif
static uint32_t s5k5e2ya_liteon_update_otp(struct otp_info_t *otp_info)
{
	uint32_t rtn = SENSOR_SUCCESS;
	//struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;

	rtn=s5k5e2ya_liteon_update_awb(otp_info);
	...
	rtn=s5k5e2ya_liteon_update_lsc(otp_info);
	if(rtn!=SENSOR_SUCCESS)
	{
...
static uint32_t s5k5e2ya_liteon_identify_otp(struct otp_info_t *otp_info)
{
	uint32_t rtn = SENSOR_SUCCESS;

	rtn=s5k5e2ya_liteon_read_otp_info(otp_info);
