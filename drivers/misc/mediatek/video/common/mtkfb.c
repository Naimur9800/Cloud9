...
#endif
#if 1 //tinno yixuhong add start,show lcd info
...
*/
   ...
   memcpy(tinno_lcm_name, mtkfb_lcm_name, 255);
...
static int mtkfb_probe(struct device *dev)
{
	...
	MSG_FUNC_LEAVE();
    tinno_create_attr(pdev);//tinno yixuhong 20140414 add to create lcd_info attr
	return 0;
...
static int mtkfb_remove(struct device *dev)
{
	...
	MSG_FUNC_LEAVE();
    tinno_delete_attr(dev);//tinno yixuhong 20140414 add to delete lcd_info attr
	return 0;
}
