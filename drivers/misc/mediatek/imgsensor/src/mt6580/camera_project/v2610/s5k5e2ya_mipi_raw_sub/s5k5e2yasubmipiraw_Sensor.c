...
#define PFX "s5k5e2yasub_camera_sensor"
...
extern struct Darling_S5K5E2SUB_otp_struct Darling_S5K5E2SUB_OTP; 
extern void Darling_S5K5E2SUB_read_OTP(struct Darling_S5K5E2SUB_otp_struct *S5K5E2SUB_OTP);
extern void Darling_S5K5E2SUB_apply_OTP(struct Darling_S5K5E2SUB_otp_struct *S5K5E2SUB_OTP);

kal_uint16 S5K5E2SUB_read_cmos_sensor(kal_uint32 addr)
{
...
void S5K5E2SUB_write_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint32 return_sensor_id(void)
{
    if(isMainCam == 0)
	    ...
	    return ((read_cmos_sensor(0x0000) << 8) | read_cmos_sensor(0x0001)) + 0x01;
...
static kal_uint32 open(void)
{
	...
	if (imgsensor_info.sensor_id != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
	Darling_S5K5E2SUB_read_OTP(&Darling_S5K5E2SUB_OTP);
	/* initail sequence write in  */
	sensor_init();
    Darling_S5K5E2SUB_apply_OTP(&Darling_S5K5E2SUB_OTP);
	spin_lock(&imgsensor_drv_lock);
