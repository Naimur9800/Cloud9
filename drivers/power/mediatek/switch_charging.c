...
#endif
#if defined(CONFIG_TINNO_SMART_CHARGE)
extern unsigned int DynamicCurrent;
#endif
/* ============================================================ // */
/* function prototype */
/* ============================================================ // */
	...
	if (BMT_status.charger_type == STANDARD_HOST)
		...
		if(g_temp_status == TEMP_POS_45_TO_POS_60){
			...
			if (BMT_status.charger_type == STANDARD_HOST){
				...
				g_temp_input_CC_value = NON_STD_AC_45_TO_60_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = NON_STD_AC_45_TO_60_TEMP_CHARGER_CURRENT;
				
			}else if (BMT_status.charger_type == STANDARD_CHARGER) {
			
				g_temp_input_CC_value = AC_45_TO_60_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = AC_45_TO_60_TEMP_CHARGER_CURRENT;
				...
				g_temp_input_CC_value = APPLE_2_1A_45_TO_60_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = APPLE_2_1A_45_TO_60_TEMP_CHARGER_CURRENT;
			...
			if (BMT_status.charger_type == STANDARD_HOST){
				...
				g_temp_input_CC_value = NON_STD_AC_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = NON_STD_AC_CHARGER_CURRENT;
				
			}else if (BMT_status.charger_type == STANDARD_CHARGER) {
			
				g_temp_input_CC_value = AC_INPUT_CHARGER_CURRENT;
				...
				g_temp_input_CC_value = APPLE_2_1A_INPUT_CHARGER_CURRENT;
			...
			if (BMT_status.charger_type == STANDARD_HOST){
				...
				g_temp_input_CC_value = NON_STD_AC_0_TO_10_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = NON_STD_AC_0_TO_10_TEMP_CHARGER_CURRENT;
				
			}else if (BMT_status.charger_type == STANDARD_CHARGER) {
			
				g_temp_input_CC_value = AC_0_TO_10_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = AC_0_TO_10_TEMP_CHARGER_CURRENT;
				
			} else if (BMT_status.charger_type == CHARGING_HOST) {
				g_temp_input_CC_value = batt_cust_data.charging_host_charger_current;
				g_temp_CC_value = batt_cust_data.charging_host_charger_current;
			} else if (BMT_status.charger_type == APPLE_2_1A_CHARGER) {
				g_temp_input_CC_value = APPLE_2_1A_0_TO_10_TEMP_INPUT_CHARGER_CURRENT;
				g_temp_CC_value = APPLE_2_1A_0_TO_10_TEMP_CHARGER_CURRENT;
			} else if (BMT_status.charger_type == APPLE_1_0A_CHARGER) {
				g_temp_input_CC_value = batt_cust_data.apple_1_0a_charger_current;
				g_temp_CC_value = batt_cust_data.apple_1_0a_charger_current;
			} else if (BMT_status.charger_type == APPLE_0_5A_CHARGER) {
		...
		battery_log(BAT_LOG_CRTI, "[BATTERY] JEITA set charging current : input_CC:%d,CC:%d\r\n",
...
static void pchr_turn_on_charging(void)
{
	...
	CHR_CURRENT_ENUM temp_CC_value = 0;
	...
	if (BMT_status.bat_charging_state == CHR_ERROR) {
		...
		if (g_temp_CC_value == CHARGE_CURRENT_0_00_MA
		    ...
		    #if defined(CONFIG_TINNO_SMART_CHARGE)
			battery_log(BAT_LOG_CRTI, "[BATTERY][SMART CHARGE] DynamicCurrent = %d\n", DynamicCurrent);
			if(DynamicCurrent)
			{
			    g_temp_CC_value = DynamicCurrent;
				battery_log(BAT_LOG_CRTI, "[BATTERY][SMART CHARGE] g_temp_CC_value = %d\n", g_temp_CC_value);
		    }
			#endif
...
//			battery_charging_control(CHARGING_CMD_SET_CURRENT, &g_temp_CC_value);
			...
			temp_CC_value = batt_cust_data.speed_current_map[batt_cust_data.target_speed];
			if(temp_CC_value != 0)
				temp_CC_value = g_temp_CC_value > temp_CC_value ?  temp_CC_value : g_temp_CC_value;
			else
				temp_CC_value = g_temp_CC_value;

			battery_log(BAT_LOG_CRTI, "g_temp_CC_value = %d, temp_CC_value = %d\n",g_temp_CC_value,temp_CC_value);

			battery_charging_control(CHARGING_CMD_SET_CURRENT, &temp_CC_value);
