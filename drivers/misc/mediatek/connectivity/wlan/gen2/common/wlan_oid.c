										   ...
										   PUINT_32 pu4InfoLen)
{
	...
	if (strnicmp(pucCmd, "addts", 5) == 0)
		eTsOp = TX_ADDTS_REQ;
	else if (strnicmp(pucCmd, "delts", 5) == 0)
		eTsOp = TX_DELTS_REQ;
	else {
