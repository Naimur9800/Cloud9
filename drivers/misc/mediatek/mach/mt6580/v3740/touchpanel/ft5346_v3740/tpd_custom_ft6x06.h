...
#define FT5446
#if defined(FT5446)
#define FTS_CTP_FIRWARE_ID  (0x542c)
#endif
#define DRIVER_NAME "FT5346I"	//for s4710 ,use ft5446i IC
#define FTS_AUTO_TP_UPGRADE //TP auto upgrade
#define FTS_APK_DEBUG  //tp debug for apk
...
#define TPD_KEYS                {KEY_BACK, KEY_HOMEPAGE, KEYCODE_APP_SWITCH}

#define TPD_KEYS_DIM    {{120, 1350, 240, 50}, \
                        {360, 1350, 240, 50}, \
                        {600, 1350, 240, 50}}
