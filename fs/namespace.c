...
//return MS_RDONLY if is need protect
//WIK_FR_OPEN_PLATFORM, dong.wang, Modify For Not Root Function
int TINNO_ROOT_PROTECT_FLAGS(char *kernel_type, char *kernel_dir)
{
	if(kernel_type != NULL	&& kernel_dir != NULL)
	{
		//if(0 == strcmp(kernel_dir->name,"/system"))
		if(0 == strcmp(kernel_dir,"/dev/block/platform/mtk-msdc.0/11120000.msdc0/by-name/system"))
		{
                        printk(KERN_INFO "enable the system protected\n");
