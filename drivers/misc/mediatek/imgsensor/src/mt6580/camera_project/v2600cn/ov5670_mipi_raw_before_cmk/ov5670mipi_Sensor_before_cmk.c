...
#include "ov5670mipi_Sensor_before_cmk.h"
...
extern bool otp_update_wb_cmk_ov5670_beofore(unsigned short golden_rg, unsigned short golden_bg);
extern signed char check_cmk_MID_ov5670_before(bool bOnlyCheck);
...
/* Sensor output window information */
kal_uint16 ov5670MIPI_read_cmos_sensor_before_cmk(kal_uint32 addr)
{
...
void ov5670MIPI_write_cmos_sensor_before_cmk(kal_uint32 addr, kal_uint32 para)
{
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror) {
		case IMAGE_NORMAL:
			...
			write_cmos_sensor(0x450b,0x00);//add to lock first pixel_b
			break;
		case IMAGE_H_MIRROR:
			write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) & 0xF9) | 0x00));
		...
		case IMAGE_V_MIRROR:
			...
			write_cmos_sensor(0x3821,((read_cmos_sensor(0x3821) & 0xF9) | 0x06));
			write_cmos_sensor(0x450b,0x20);//add to lock first pixel_b
			break;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if( 0==check_cmk_MID_ov5670_before(true) ) //it is not cmk module
    	{	
	    ...
	    *sensor_id = OV5670MIPI_SENSOR_ID_BEFORE_CMK;
	return ERROR_NONE;
}
...
static kal_uint32 open(void)
{
	...
	sensor_init();
    otp_update_wb_cmk_ov5670_beofore(0x11E, 0x141);// typical for 2600 front camera
...
UINT32 OV5670_MIPI_RAW_SensorInit_before_CMK(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
